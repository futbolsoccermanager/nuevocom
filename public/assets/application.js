...
(function() {
  ...
  $(function() {
    ...
    $('.makeofer').click(function() {
      var errors;
      errors = false;
      $('.valofer').each(function() {
        if ($(this).val()) {
          if (!$.isNumeric($(this).val())) {
            $(this).parent().parent().addClass('error');
            return errors = true;
          } else {
            return $(this).parent().parent().addClass('info');
          }
        }
      });
      if (!errors) {
...
// jquery_ujs se quita de momento porque duplica submit ??
//
